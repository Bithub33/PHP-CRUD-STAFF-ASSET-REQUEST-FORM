<?php
    ...
    $id = "";$dat = "";$reqFor = "";$dept ="";$loc = "";$contact = "";$audited = "PENDING";$status = "PENDING";$type = "";$soft_replacement = "";$hrepl = "";$oldHardName = "";$oldHardModel = "";$oldHardSerial = "";$oldTagNum = "";$oldHardCond = "";$newHardName = "";$newHardSerial = "";$newHardModel = "";$newHardCond = "";$softreqtype = "";$oldSoftModel = "";$oldSoftSerial = "";$oldSoftCond = "";$newSoftName = "";$newSoftModel = "";$newSoftSerial = "";$newSoftCond = "";$implementedby = "";$auditedby = "";$sres="";$hres="";$date="";$email="";$erpname="";$erppass="";$erprole="";$erpshop="";$sites="";$emailimprem="";$intimprem="";$bioimprem="";$softimprem="";$empcode="";$newImpHardName="";$reqsites="";$audrem="";$Audstatus="";
    ...
    if($_SERVER['REQUEST_METHOD'] == "GET")
    {
        ...
        $id=clean($_POST['id']);$table=clean($_POST['table']);$name=$_SESSION['name'];$pg=$_POST['pg'];$audrem=$_POST['audrem'];
        ...
        do{
            ...
            {
                $sql = "UPDATE $table SET Audited='APPROVED', Auditedby='$name', AudRem='$audrem', AudDate='$date' WHERE Ticketid='$id'";
                ...
                $sql = "UPDATE $table SET Audited='DECLINED', Auditedby='$name',AudRem='$audrem', AudDate='$date' WHERE Ticketid='$id'";
...
<div class="content">
    ...
    <div class="con mt-3">
        ...
        <div class="opt" style="margin-top: 20px;">
            <div class="column mb-3">
                ...
                <div class="">
                    <input style="width: 100%;" id="audrem" type="text" name="audrem" value="<?php echo $audrem?>" class="form-control" oninput="this.value = this.value.toUpperCase();">
                    <span id="err" style="color: red; display: none">Field cannot be empty</span>
                </div>
    ...
    if($Audstatus == 'APPROVED' || $Audstatus == 'DECLINED' ||
     $Audstatus == 'Approved' || $Audstatus == 'Declined')
    {
        ?>
        <div class="row mb-3">
            <div class="col-sm-3 d-grid mt-5">
                <button  type="submit" name="action" value="approve" class="btn btn-primary" disabled><i class="fa-solid fa-spinner fa-spin" style="display: none;" id="load"></i>
                    Approve
                </button>
            </div>
            <div class="col-sm-3 d-grid mt-5">
                <button  type="submit" name="action" value="decline" class="bt btn btn-outline-primary" disabled><i class="fa-solid fa-spinner fa-spin" style="display: none;" id="load"></i>
                    Decline
                </button>
            </div>
        </div>
